//go:build linux && !notorch

package main

// On Linux: link against OpenBLAS (apt install libopenblas-dev)
// Same cblas API as Apple Accelerate — accel.c works unchanged.

// #cgo CFLAGS: -I/usr/include/openblas -O2

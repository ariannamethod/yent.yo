...
**Dual Yent + BK-SDM-Base (579M UNet) + 30 steps + HAiKU Dissonance + Oppositional React + Web UI. Pure Go, zero Python at runtime.**
...
Full Go pipeline: micro-Yent (69M) + nano-Yent (46M) + BK-SDM-Base (579M) + Go postprocessing.

| | | |
|---|---|---|
| ![who](gallery/who_are_you.png) | ![cat](gallery/draw_me_a_cat.png) | ![fuckoff](gallery/fuck_off.png) |
| *"who are you"* | *"draw me a cat"* | *"fuck off"* |
| ![meaning](gallery/the_meaning_of_life.png) | ![revolution](gallery/revolution.png) | ![nothing](gallery/i_feel_nothing.png) |
| *"the meaning of life"* | *"revolution"* | *"I feel nothing"* |
| ![test](gallery/test.png) | | |
| *"test"* | | |
...
5. **UNet** denoises latent, 30 steps (~110s CPU / ~0.5s GPU)
